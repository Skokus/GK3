    ...
    public static ArrayList<Material> materials = new ArrayList<>() {
        {
            ...
            add(new Material(0.25, 0.4, 0.774597, 76.8, "Polished Bronze", new Color(205, 127, 50)));
            add(new Material(0.19225, 0.50754, 0.508273, 51.2, "Silver", new Color(192,192,192)));
            add(new Material(0.23125, 0.2775, 0.773911, 89.6, "Polished Silver", new Color(192,192,192)));
            add(new Material(0.24725, 0.75164, 0.628281, 51.2, "Gold", new Color(255,215,0)));
            add(new Material(0.24725, 0.34615, 0.797357, 83.2, "Polished Gold", new Color(255,215,0)));
